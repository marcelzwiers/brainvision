...
def read_ini(filename):
    ...
    for line in lines:
        ...
        if line.startswith(';'):
            ...
            section = line[1:-1].replace(' infos', ' Infos')    # NeurOne BrainVision export workaround, e.g. as in: https://github.com/mne-tools/mne-testing-data/blob/master/Brainvision/test_NO.vhdr
            ini[section] = {}
        elif '=' in line:
